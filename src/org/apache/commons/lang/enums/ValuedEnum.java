 ...
 * 
 * <p>
 * <em>NOTE:</em>These are declared <code>final</code>, so compilers may inline
 * the code. Ensure you recompile everything when using final.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * <em>NOTE:</em> Because the switch is ultimately sitting on top of an int, the
 * example above is not type-safe. That is, there is nothing that checks that
 * JAVA1_0_VALUE is a legal constant for JavaVersionEnum.
 * </p>
 * 
 * <p>
