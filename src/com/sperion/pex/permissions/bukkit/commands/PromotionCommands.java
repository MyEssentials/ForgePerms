...
public class PromotionCommands extends PermissionsCommand {
    ...
    public void rankGroup(Object plugin, ICommandSender sender,
    ...
    public void promoteUser(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        ...
        if (sender instanceof EntityPlayer) {
            promoter = PermissionsEx.getPermissionManager().getUser(
                    ((EntityPlayer) sender).username);
            if (promoter == null
    ...
    public void demoteUser(Object plugin, ICommandSender sender,
        ...
        if (sender instanceof EntityPlayer) {
            demoter = PermissionsEx.getPermissionManager().getUser(
                    ((EntityPlayer) sender).username);
        ...
        try {
            PermissionGroup targetGroup = user.demote(demoter, args
                    .get("ladder"));
    ...
    public void promoteUserAlias(Object plugin, ICommandSender sender,
            Map<String, String> args) {
    ...
    public void demoteUserAlias(Object plugin, ICommandSender sender,
            Map<String, String> args) {
