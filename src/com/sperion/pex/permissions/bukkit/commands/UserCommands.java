...
public class UserCommands extends PermissionsCommand {
    ...
    public void usersList(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        PermissionUser[] users = PermissionsEx.getPermissionManager()
                .getUsers();
        ...
        for (PermissionUser user : users) {
            sender.sendChatToPlayer(" " + user.getName() + " "
                    ...
                    + StringUtils.implode(user.getGroupsNames(), ", ") + "]");
        }
    }
    ...
    public void userListAlias(Object plugin, ICommandSender sender,
            Map<String, String> args) {
    ...
    public void userListAnotherAlias(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        this.usersList(plugin, sender, args);
    }
    ...
    public void userListAliasPermissions(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        ...
        sender.sendChatToPlayer(userName + " are member of:");
        ...
        sender.sendChatToPlayer(userName + "'s permissions:");

        this.sendMessage(sender, this.mapPermissions(worldName, user, 0));

        sender.sendChatToPlayer(userName + "'s options:");
        for (Map.Entry<String, String> option : user.getOptions(worldName)
                .entrySet()) {
    ...
    public void userListPermissions(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        for (String permission : user.getPermissions(worldName)) {
            sender.sendChatToPlayer("  " + permission);
        }
    ...
    public void userListSuperPermissions(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        ...
        sender.sendChatToPlayer(userName + "'s superperms: ");
         ...
         * 
         * sender.sendChatToPlayer(" '" + ChatColor.GREEN + info.getPermission()
         * + ChatColor.WHITE + "' = " + ChatColor.BLUE + info.getValue() +
         * ChatColor.WHITE + " by " + ChatColor.DARK_GREEN + pluginName); }
         */
    }
    ...
    public void userPrefix(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        sender.sendChatToPlayer(user.getName() + "'s prefix = \""
                + user.getPrefix() + "\"");
    }
    ...
    public void userSuffix(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
    ...
    public void userToggleDebug(Object plugin, ICommandSender sender,
        ...
        sender.sendChatToPlayer("Debug mode for user " + userName + " "
                + (user.isDebug() ? "enabled" : "disabled") + "!");
    }
    ...
    public void userCheckPermission(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        String permission = user.getMatchingExpression(args.get("permission"),
                worldName);

        if (permission == null) {
            sender.sendChatToPlayer("Player \"" + userName
                    + "\" don't such have no permission");
        } else {
            sender.sendChatToPlayer("Player \"" + userName + "\" have \""
                    + permission + "\" = " + user.explainExpression(permission));
        }
    }
    ...
    public void userGetOption(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        sender.sendChatToPlayer("Player " + userName + " @ " + worldName
    ...
    public void userDelete(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        PermissionUser user = PermissionsEx.getPermissionManager().getUser(
                userName);
        ...
        if (user.isVirtual()) {
            sender.sendChatToPlayer(ChatColor.RED + "User is virtual");
        }
    ...
    public void userAddPermission(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        sender.sendChatToPlayer(ChatColor.WHITE + "Permission \""
                + args.get("permission") + "\" added!");

        this.informPlayer(plugin, userName,
    ...
    public void userRemovePermission(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        String permission = this.autoCompletePermission(user, args
    ...
    public void userSwapPermission(Object plugin, ICommandSender sender,
        ...
        try {
            int sourceIndex = this.getPosition(this.autoCompletePermission(
                    user, args.get("permission"), worldName, "permission"),
                    permissions);
            int targetIndex = this.getPosition(this.autoCompletePermission(
                    user, args.get("targetPermission"), worldName,
    ...
    public void userAddTimedPermission(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        logger.info("User " + userName + " get timed permission \""
                + args.get("permission") + "\" "
    ...
    public void userRemoveTimedPermission(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        String permission = args.get("permission");
    ...
    public void userSetOption(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
    ...
    public void userListGroup(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        sender.sendChatToPlayer("User " + args.get("user") + " @" + worldName
                + " currently in:");
        for (PermissionGroup group : user.getGroups(worldName)) {
            sender.sendChatToPlayer("  " + group.getName());
        }
    }
    ...
    public void userAddGroup(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        ...
        if (args.containsKey("lifetime")) {
            try {
                ...
                sender.sendChatToPlayer(ChatColor.RED
                        + "Group lifetime should be number!");
                return;
            }
        ...
        sender.sendChatToPlayer(ChatColor.WHITE + "User added to group \""
                + groupName + "\"!");
    ...
    public void userSetGroup(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        PermissionManager manager = PermissionsEx.getPermissionManager();

        PermissionUser user = manager.getUser(this.autoCompletePlayerName(args
                .get("user")));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        if (groupName.contains(",")) {
            ...
            for (int i = 0; i < groupsNames.length; i++) {
                if (sender instanceof EntityPlayer
                        && !manager.has((EntityPlayer) sender,
                                "permissions.manage.membership."
                                        + groupsNames[i].toLowerCase())) {
                    sender.sendChatToPlayer(ChatColor.RED
                            + "Don't have enough permission for group "
                            + groupsNames[i]);
                    return;
                }

                groups[i] = manager.getGroup(this
                        .autoCompleteGroupName(groupsNames[i]));
            }
            ...
            if (groupName != null) {
                ...
                sender.sendChatToPlayer(ChatColor.RED + "No groups set!");
                return;
            }
        }
        ...
        if (groups.length > 0) {
            ...
            sender.sendChatToPlayer(ChatColor.WHITE + "User groups set!");
        } else {
            sender.sendChatToPlayer(ChatColor.RED + "No groups set!");
        }

        this.informPlayer(plugin, user.getName(), "You are now only in \""
                + groupName + "\" group");
    }
    ...
    public void userRemoveGroup(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        String userName = this.autoCompletePlayerName(args.get("user"));
        String groupName = this.autoCompleteGroupName(args.get("group"));
        String worldName = this.autoCompleteWorldName(args.get("world"));
        ...
        sender.sendChatToPlayer(ChatColor.WHITE + "User removed from group "
                + groupName + "!");
    ...
    public void usersCleanup(Object plugin, ICommandSender sender,
            Map<String, String> args) {
        ...
        if (args.containsKey("threshold")) {
            try {
                ...
                sender.sendChatToPlayer(ChatColor.RED
                        + "Threshold should be number (in days)");
                return;
            }
        }
        ...
        for (PermissionUser user : group.getUsers()) {
            int lastLogin = user
                    .getOwnOptionInteger("last-login-time", null, 0);
        ...
        sender.sendChatToPlayer("Cleaned " + removed + " users");
    }
}
