...
public class UserCommands extends PermissionsCommand {
    ...
    public void userListSuperPermissions(Object plugin, ICommandSender sender,
         ...
         * 
         * PermissionsEx.sendChatToPlayer(sender, " '" + ChatColor.GREEN + info.getPermission()
    ...
    public void userPrefix(Object plugin, ICommandSender sender,
        ...
        PermissionsEx.sendChatToPlayer(sender, user.getName() + "'s prefix = \""
                + user.getPrefix() + "\"");
    }
    ...
    public void userSuffix(Object plugin, ICommandSender sender,
        ...
        PermissionsEx.sendChatToPlayer(sender, user.getName() + "'s suffix = \""
                + user.getSuffix() + "\"");
    }
    ...
    public void userToggleDebug(Object plugin, ICommandSender sender,
        ...
        PermissionsEx.sendChatToPlayer(sender, "Debug mode for user " + userName + " "
    ...
    public void userCheckPermission(Object plugin, ICommandSender sender,
        ...
        if (permission == null) {
            PermissionsEx.sendChatToPlayer(sender, "Player \"" + userName
                    + "\" don't such have no permission");
        } else {
            PermissionsEx.sendChatToPlayer(sender, "Player \"" + userName + "\" have \""
    ...
    public void userGetOption(Object plugin, ICommandSender sender,
        ...
        PermissionsEx.sendChatToPlayer(sender, "Player " + userName + " @ " + worldName
    ...
    public void userListGroup(Object plugin, ICommandSender sender,
        ...
        PermissionsEx.sendChatToPlayer(sender, "User " + args.get("user") + " @" + worldName
                + " currently in:");
    ...
    public void userAddGroup(Object plugin, ICommandSender sender,
        ...
        PermissionsEx.sendChatToPlayer(sender, ChatColor.WHITE + "User added to group \""
                + groupName + "\"!");
    ...
    public void userRemoveGroup(Object plugin, ICommandSender sender,
        ...
        PermissionsEx.sendChatToPlayer(sender, ChatColor.WHITE + "User removed from group "
                + groupName + "!");
