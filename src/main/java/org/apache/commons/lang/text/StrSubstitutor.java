...
public class StrSubstitutor {
     ...
     * start of a variable. This method allows a single character prefix to be
     * easily set.
     * 
     * @param prefix
     ...
     * Sets the variable suffix to use.
     * <p>
     * The variable suffix is the character or characters that identify the end
