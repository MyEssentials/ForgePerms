...
public class DurationFormatUtils {
    ...
    public static String formatDuration(long durationMillis, String format,
        ...
        if (Token.containsTokenWithValue(tokens, m)) {
            ...
            durationMillis = durationMillis - minutes
                    * DateUtils.MILLIS_PER_MINUTE;
        }
        if (Token.containsTokenWithValue(tokens, s)) {
            seconds = (int) (durationMillis / DateUtils.MILLIS_PER_SECOND);
            durationMillis = durationMillis - seconds
    ...
    public static String formatPeriod(long startMillis, long endMillis,
            String format) {
        return formatPeriod(startMillis, endMillis, format, true, TimeZone
                .getDefault());
    }
    ...
    static String format(Token[] tokens, int years, int months, int days,
        ...
        for (int i = 0; i < sz; i++) {
            ...
            if (value instanceof StringBuffer) {
                ...
                if (value == y) {
                    buffer.append(padWithZeros ? StringUtils.leftPad(Integer
                    ...
                    if (lastOutputSeconds) {
                        milliseconds += 1000;
                        String str = padWithZeros ? StringUtils.leftPad(Integer
