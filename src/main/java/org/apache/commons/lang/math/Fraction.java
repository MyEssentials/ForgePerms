...
public final class Fraction extends Number implements Comparable {
	...
	public String toString() {
		if (toString == null) {
			toString = new StrBuilder(32).append(getNumerator()).append('/').append(getDenominator()).toString();
		}
		return toString;
	}
		...
		if (toProperString == null) {
			if (numerator == 0) {
				...
				if (properNumerator == 0) {
					...
					toProperString = new StrBuilder(32).append(getProperWhole()).append(' ').append(properNumerator).append('/').append(getDenominator()).toString();
				}
			} else {
				toProperString = new StrBuilder(32).append(getNumerator()).append('/').append(getDenominator()).toString();
			}
		}
