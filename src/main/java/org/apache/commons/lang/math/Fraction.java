...
public final class Fraction extends Number implements Comparable {
    ...
    private Fraction addSub(Fraction fraction, boolean isAdd) {
        ...
        if (d1 == 1) {
            ...
            return new Fraction(isAdd ? addAndCheck(uvp, upv) : subAndCheck(
                    uvp, upv),
    ...
    public Fraction multiplyBy(Fraction fraction) {
        ...
        return getReducedFraction(mulAndCheck(numerator / d1,
                fraction.numerator / d2), mulPosAndCheck(denominator / d2,
    ...
    public String toString() {
        if (toString == null) {
            toString = new StrBuilder(32).append(getNumerator()).append('/')
    ...
    public String toProperString() {
        if (toProperString == null) {
            if (numerator == 0) {
                ...
                toProperString = new StrBuilder(32).append(getNumerator())
