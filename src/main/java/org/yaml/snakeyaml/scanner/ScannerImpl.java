...
public final class ScannerImpl implements Scanner {
	...
	private int nextPossibleSimpleKey() {
		...
		if (!possibleSimpleKeys.isEmpty()) {
			return possibleSimpleKeys.values().iterator().next().getTokenNumber();
		}
		return -1;
	}
	...
	private void stalePossibleSimpleKeys() {
		if (!possibleSimpleKeys.isEmpty()) {
			for (Iterator<SimpleKey> iterator = possibleSimpleKeys.values().iterator(); iterator.hasNext();) {
