...
public class Constructor extends SafeConstructor {
	...
	protected class ConstructScalar extends AbstractConstruct {
		...
		public Object construct(Node nnode) {
			...
			Object result;
			if (type.isPrimitive() || type == String.class || Number.class.isAssignableFrom(type) || type == Boolean.class || Date.class.isAssignableFrom(type) || type == Character.class || type == BigInteger.class || type == BigDecimal.class || Enum.class.isAssignableFrom(type)
