...
public class StringUtil {
     ...
     *             if the collection is immutable and originals contains a
     *             string which starts with the specified search string.
     * @throws IllegalArgumentException
     *             if any parameter is is null
     * @throws IllegalArgumentException
     *             if originals contains a null element. <b>Note: the collection
     *             may be modified before this is thrown</b>
     */
    public static <T extends Collection<String>> T copyPartialMatches(
            final String token, final Iterable<String> originals,
     ...
     * means the internal array does not need to be copied like a toLowerCase()
     * call would.
     * 
     * @param string
     *            String to check
    ...
    public static boolean startsWithIgnoreCase(final String string,
            final String prefix) throws IllegalArgumentException,
