...
public class HandlerList {
     ...
     *            plugin to remove
     */
    public synchronized void unregister(Object plugin) {
    ...
    public synchronized void bake() {
        ...
        for (Entry<EventPriority, ArrayList<RegisteredListener>> entry : handlerslots
                .entrySet()) {
     ...
     */
    public static ArrayList<RegisteredListener> getRegisteredListeners(
            Object plugin) {
